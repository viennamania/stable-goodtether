...
export default function SettingsPage({ params }: any) {
  ...
  const inAppConnectWallet = connectWallets?.[1];
    ...
    const [sellerForClearance, setSellerForClearance] = useState(null) as any;
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (data.result) {
                ...
                setSellerForClearance(data.result.sellerForClearance);
    ...
    const apply = async () => {
      ...
      try {
        ...
        /*
          ...
          await fetch('/api/user/updateSellerForClearance', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
